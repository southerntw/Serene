...
@Composable
fun FillDataScreen(modifier: Modifier = Modifier, navHostController: NavHostController) {
        FillDataContent(modifier = Modifier,
...
@Composable
fun FillDataContent(modifier: Modifier,
userAvatar: Int,
userName: String,
about: String,
birthdate: String,
